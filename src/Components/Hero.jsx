...
//         { name: 'MongoDB', icon: 'Universe', color: 'from-green-500 to-emerald-400' },
...
//             const delta = (timestamp - lastTimestamp) / 16; // Normalize to ~60fps
...
//                 return prevPositions.map(logo => {
//                     let newX = logo.x + logo.vx * delta;
//                     let newY = logo.y + logo.vy * delta;
//                     let newVx = logo.vx;
//                     let newVy = logo.vy;

//                     // Check collision with profile photo
//                     const dx = newX - profileCenter.x;
//                     const dy = newY - profileCenter.y;
//                     const distance = Math.sqrt(dx * dx + dy * dy);

//                     if (distance < profileRadius + 30) { // 30 is logo radius
...
//                         newVx = Math.cos(angle) * speed * randomFactor;
//                         newVy = Math.sin(angle) * speed * randomFactor;
                        
//                         // Move logo outside collision area
//                         newX = profileCenter.x + (profileRadius + 30) * Math.cos(angle);
//                         newY = profileCenter.y + (profileRadius + 30) * Math.sin(angle);
//                     }
...
//     return (
//         <div ref={containerRef} className="bg-neutral-950 text-white py-16 min-h-screen flex items-center overflow-hidden relative">
//             {/* Moving Skill Logos */}
...
//                     }}
//                 >
//                     <div className={`flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r ${logo.skill.color} p-0.5 animate-pulse shadow-lg`}>
...
//                             Hey everyone! Out of 9.2 million full-stack developers across the globe, I’m proud to be one of them building, creating, and innovating every day!
//                             </motion.p>
...
//                         <div ref={profileRef} className="relative mx-auto w-80 h-80">
//                             <div className="w-full h-full rounded-full border-4 border-purple-500 overflow-hidden shadow-2xl shadow-purple-500/20 hover:shadow-purple-500/40 transition-shadow duration-300">
//                                 {/* <img 
//                                     src=""
//                                     alt="Profile"  */}
//                                     <img 
